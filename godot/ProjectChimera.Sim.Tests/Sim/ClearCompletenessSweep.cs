...
namespace ProjectChimera.Sim.Tests.Sim
{
    ...
    public static class ClearCompletenessSweep
    {
        ...
        /// <see cref="DeathLog"/> by observable state (Count + records up to Count); arrays elementwise (any rank,
        /// recursing into jagged); strings by value; dictionaries by key-lookup; other enumerables (List/Queue/…)
        /// ordered-structurally; everything else by <see cref="object.Equals(object?,object?)"/>.</summary>
        public static string? DescribeValueDivergence(object? a, object? b)
        {
            ...
            if (a is DeathLog dla && b is DeathLog dlb)
            {
                ...
                return DescribeDeathLogDivergence(dla, dlb);
            }
