...
namespace ProjectChimera.Sim.Tests.Sim
{
    ...
    public class StoreClearCompletenessTests
    {
        ...
        private static StoreResetFixture WinConCase()
        {
            ...
            var fresh = new WinConditionSystem(winState, buildings, factions, alliances);
            var dirty = new WinConditionSystem(winState, buildings, factions, alliances);
            ...
            return new StoreResetFixture("WinCon.ResetConfig()", fresh, dirty, dirty.ResetConfig)
            {
                ...
                DirtyNonArrayState = () =>
                {
                    ...
                    ClearCompletenessSweep.Poke(dirty, "_leaderEntityId", 5);
                ...
                Allowlist = new[]
                {
                    ...
                    "_store", "_buildings", "_factions", "_alliances",
