...
namespace ProjectChimera.Sim.Tests.Validation
{
    ...
    public class CanonicalModelHashPathabilityTests
    {
        ...
        [Fact]
        public void AlgoVersion_IsTwelve() => Assert.Equal(12, CanonicalModelHash.AlgoVersion); // 7.5 re-land merge: 9→10 (custom-events fold); Story 7.9: 10→11 (Button fold). Pathability folds below unchanged.
