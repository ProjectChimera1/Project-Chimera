...
namespace ProjectChimera.Sim.Tests.Validation
{
    ...
    public class CanonicalModelHashTests
    {
        ...
        [Fact]
        public void AlgoVersion_IsTwelve() => Assert.Equal(14, CanonicalModelHash.AlgoVersion); // 7.5 re-land merge bumped 9→10 (custom-events registry + graph node-kind fold); Story 7.9: 10→11 (Button fold)
