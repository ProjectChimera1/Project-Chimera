...
namespace ProjectChimera.Dsl
{
    ...
    /// so it folds into <c>SimChecksum</c> (the story's ONE sanctioned re-baseline, AlgoVersion 16→17).
    ///
    ...
    public sealed class DslEventQueue
    {
        ...
        /// <summary>
        /// Fold the pending queue into the running FNV-1a <paramref name="hash"/> (SimChecksum v17): a leading
