        ...
        private void HandlePacket(byte[] data, int len, int channel)
        {
            ...
            switch (type)
            {
                ...
                case PacketType.Ready:
                {
                    ...
                    // DW-402: the peer-Ready version clause lives in the Godot-free LobbyVersionGate (Tier-1
                    // pinned); DW-403: while the gate is version-blocked, ANY Ready is refused fail-closed until
                    // a valid Hello recovers the lobby.
