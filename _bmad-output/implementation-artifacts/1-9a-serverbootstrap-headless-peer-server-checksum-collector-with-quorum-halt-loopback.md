...
- [ ] [Review][Patch] **Spectator checksums pollute the strict-majority quorum — half-implemented D6 (`HIGH`)** [godot/src/Multiplayer/DedicatedServer.cs:173 + godot/src/Multiplayer/LockstepManager.cs:352]
...
- [ ] [Review][Patch] **Terminal HALT overlay mislabels an attributed desync with canonical hash `0x00000000` as a global no-majority halt (`LOW`/cosmetic)** [godot/src/Core/MainScene.cs ShowHalt + godot/src/Multiplayer/LockstepManager.cs:367]
