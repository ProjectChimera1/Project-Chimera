...
- Staged loading screen + briefing surface w/ objectives + subtitles (11.5, 7.18)
...
- Trigger debugger overlay: variable watch + fired-trigger log (7.19); quest-log panel + objective toasts (7.18)
